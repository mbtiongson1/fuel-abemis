...
\begin{itemize}
  \item \textbf{Expand the AMTEC corpus:} Tesseract OCR has been applied to the 267 scanned reports available during this study. Acquiring the remaining collaborator set (estimated 3{,}065 PDFs) and re-running the extraction pipeline would substantially expand the corpus beyond 376 records, with the largest gains expected in underrepresented machinery types (small-scale tillers, irrigation pumps, post-harvest equipment).
